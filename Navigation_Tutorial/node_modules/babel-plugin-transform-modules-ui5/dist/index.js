  ...
  const UI5Visitor = _objectSpread({
    Program: {
      enter(path, {
        ...
        var _path$parent$comments, _path$parent;
        if (this.ran) return;
        this.ran = true;
        ...
        this.noWrap = ((_path$parent$comments = (_path$parent = path.parent) === null || _path$parent === void 0 ? void 0 : _path$parent.comments) !== null && _path$parent$comments !== void 0 ? _path$parent$comments : []).some(c => c.type === "CommentBlock" && c.value.trim() === "@ui5-no-wrap");
      ...
      exit(path, {
        ...
        path.traverse({
          ImportDeclaration: _visitor2.ModuleTransformVisitor.ImportDeclaration
        }, this);
